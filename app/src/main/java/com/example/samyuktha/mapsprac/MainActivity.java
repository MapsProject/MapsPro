    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent inc= new Intent(MainActivity.this, Main3Activity.class);

                inc.putParcelableArrayListExtra("samhello", (ArrayList<? extends Parcelable>) doll);
                startActivity(inc);
...
//        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        map.addMarker(new MarkerOptions().position(new LatLng(latitude, longitude)).title("current position"));
